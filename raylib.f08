! raylib v4.2 Bindings for Fortran '08
! MPL 2.0 License
...
!typedef bool (*SaveFileTextCallback)(const char *fileName, char *text); // FileIO: Save text data
   ...
   interface
      ...
      function WindowShouldClose () result (res) bind (c, name="WindowShouldClose")
         import :: c_bool
         logical(c_bool) :: res
      end function
      ...
      function IsWindowReady () result (res) bind (c, name="IsWindowReady")
         import :: c_bool
         logical(c_bool) :: res
      end function

      function IsWindowFullscreen () result (res) bind (c, name="IsWindowFullscreen")
         import :: c_bool
         logical(c_bool) :: res
      end function

      function IsWindowHidden () result (res) bind (c, name="IsWindowHidden")
         import :: c_bool
         logical(c_bool) :: res
      end function

      function IsWindowMinimized () result (res) bind (c, name="IsWindowMinimized")
         import :: c_bool
         logical(c_bool) :: res
      end function

      function IsWindowMaximized () result (res) bind (c, name="IsWindowMaximized")
         import :: c_bool
         logical(c_bool) :: res
      end function

      function IsWindowFocused () result (res) bind (c, name="IsWindowFocused")
         import :: c_bool
         logical(c_bool) :: res
      end function

      function IsWindowResized () result (res) bind (c, name="IsWindowResized")
         import :: c_bool
         logical(c_bool) :: res
      end function

      function IsWindowState (flag) result (res) bind (c, name="IsWindowState")
         import :: c_bool
         import :: c_int
...
!// Timing-related functions
      ...
      function GetFPS () result (res) bind (c, name="GetFPS")
         import :: c_int
         integer(c_int) :: res
      end function
